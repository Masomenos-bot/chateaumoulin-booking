...
export async function handler(event) {
  ...
  try {
    ...
    if (booking.contributor_rate) {
      ...
      // Replicate tier/bucket pricing logic
...
<body style="margin:0; padding:0; background-color:#F5F3ED;">
  <table width="100%" cellpadding="0" cellspacing="0" style="background-color:#F5F3ED; padding:40px 20px;">
                      ...
                      <table cellpadding="0" cellspacing="0" border="0"><tr>
                        <td style="background:#000; padding:0 4px 0 0;">
                          <div style="background-color:#8B9DC3; padding:5px 12px; border:3px solid #000;">
                            <span style="font-family:'Courier New',Courier,monospace; font-size:10px; font-weight:700; letter-spacing:0.12em; color:#000; text-transform:uppercase;">QUOTE</span>
                          </div>
                        </td>
                      </tr></table>
                    </td>
          ...
          <td style="padding:28px 0 0;" align="center">
            <table cellpadding="0" cellspacing="0" border="0"><tr>
              <td style="background:#000; padding:0 0 4px 0;">
                <table cellpadding="0" cellspacing="0" border="0"><tr>
                  <td style="background:#000; padding:0 4px 0 0;">
                    <a href="${session.url}" target="_blank" style="display:block; background-color:#A8D4B8; padding:14px 40px; border:3px solid #000; text-decoration:none;">
                      <span style="font-family:'Courier New',Courier,monospace; font-size:12px; font-weight:700; letter-spacing:0.14em; color:#000; text-transform:uppercase;">PAY DEPOSIT · ${deposit} &euro;</span>
                    </a>
                  </td>
                </tr></table>
              </td>
    ...
    const emailResponse = await resend.emails.send({
      ...
      to: booking.email,
      subject: `Your Booking Quote — Chateaumoulin #${bookingId.slice(0, 8).toUpperCase()}`,
      html: emailHtml,
    });
