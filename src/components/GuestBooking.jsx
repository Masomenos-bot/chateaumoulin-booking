        ...
        <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: 11, fontFamily: C }}>
          <thead>
            <tr style={{ borderBottom: `1px solid ${BD}` }}>
              ...
              <td style={{ padding: '6px 4px', textAlign: 'center', fontWeight: 700, fontFamily: H, fontSize: 10 }}>Tier 1<br /><span style={{ fontWeight: 400, fontSize: 8, color: MU }}>before May 15</span></td>
